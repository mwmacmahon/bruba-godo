...
Standalone guide for connecting Moltbot (or any Clawdbot-based bot) to Signal for mobile messaging with voice support.

> **Framework vs Bot Name:** This guide uses "Moltbot/Clawdbot" for the framework software. Your bot's name (e.g., "Bruba") is yours to choose.
...
2. [Install signal-cli](#part-1-install-signal-cli)
3. [Link signal-cli to Your Phone](#part-2-link-signal-cli-to-your-phone)
4. [Configure Clawdbot](#part-3-configure-clawdbot)
5. [Test](#part-4-test)
6. [Voice Message Handling](#part-5-voice-message-handling)
7. [Agent Configuration](#part-6-agent-configuration)
...
- [Moltbot Signal Docs](https://docs.molt.bot/channels/signal)
